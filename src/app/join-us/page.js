...
export default function JoinUs() {
    return(
        ...
        <Image
            ...
            width={200}
            height={200}
            className="absolute right-48 top-1/2 translate-y-24 max-sm:invisible visible"
        />
        <div className="max-w-full max-h-fit bg-white grid grid-flow-cols text-secondary text-xl max-sm:text-sm mt-28 mb-10 max-sm:mx-2 mx-20 gap-y-2 items-center">
        ...
        <div className="max-w-fit w-screen h-fit mb-20 px-60 max-sm:px-10">
        ...
        <div className="max-w-full w-screen h-fit max-sm:px-2 px-20 flex flex-col gap-2">
